		...
		<div class="container">
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="${page1}"><a href="index.html">Поиск документов</a></li>
						<li class="${page2}"><a href="about.html">Как это
								работает?</a></li>
					<div class="clearfix"></div>
					<!-- script-for-menu -->
					<script>
				...
				<div class="dropdown-grids">
					<div id="loginContainer">
						<a href="#" id="loginButton"><span>Войти</span></a>
						<div id="loginBox">
							<c:url value="/j_security_check" var="href" />
							<form action="${href}" method="POST" id="loginForm">

								<div class="login-grids">
									<div class="login-grid-left">
										<c:if test="${not empty SPRING_SECURITY_LAST_EXCEPTION}">
											<div class="alert alert-danger">Неверный логин или
												пароль</div>
										</c:if>
										<div class="form-group">
											<label for="login">Логин</label> <input type="text"
												class="form-control" id="log" name="j_username" value=""
												placeholder="Логин">
										</div>
										<div class="form-group">
											<label for="passwd">Пароль</label> <input type="password"
												class="typeahead1 input-md form-control tt-input"
												id="passwd" name="j_password" value="" placeholder="Пароль">
										</div>
										<div class="checkbox">
							...
							<p></p>
							<p></p>
							<span><a href="recovery.html">Забыли пароль?</a></span>
							<div class="or-grid">
								<p>ИЛИ</p>
							</div>
							...
							<div class="button-bottom">
								<p>
									Новый аккаунт? <a href="signup.html">Зарегистрируйтесь</a>
								</p>
							</div>
						</div>
					</div>
