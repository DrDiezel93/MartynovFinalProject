							...
							<div class="p-table">
								<div class="p-table-grids">
									...
									<div class="col-md-3 p-table-grid">
										...
										<form method="POST" action="/study/upload_spec_ant.html"
									...
									<div class="col-md-3 p-table-grid">
										...
										<form method="POST" action="/study/upload_spec_exp.html"
											enctype="multipart/form-data">
									...
									<div class="col-md-3 p-table-grid">
										...
										<form method="POST" action="/study/protect_spec.html">
											<div class="reservation">
												...
												<div class="sp-bor-btn">
													...
													<div class="btn">
														<tn:href href="/del_sec_spec_doc.html?id=${doc.id}"
